...
WebUI.verifyElementPresent(findTestObject('06 - Menu Toolbar (Top Right)/TC_59-chat_Colleague_Empty_Information/Page_Home page/div_Please enter the message'), 
    0)

WebUI.click(findTestObject('06 - Menu Toolbar (Top Right)/TC_59-chat_Colleague_Empty_Information/Page_Home page/button_OK'))
