...
resultDescription = CustomKeywords.'menuToolbar.sharesuggestion.shareSuggestion'(subject)

WebUI.setText(findTestObject('06 - Menu Toolbar (Top Right)/TC_63-share_Suggestion/Page_Home page/input_specify_Area'), 
    subject)

WebUI.setText(findTestObject('06 - Menu Toolbar (Top Right)/TC_63-share_Suggestion/Page_Home page/input_Suggestion'), resultDescription)
