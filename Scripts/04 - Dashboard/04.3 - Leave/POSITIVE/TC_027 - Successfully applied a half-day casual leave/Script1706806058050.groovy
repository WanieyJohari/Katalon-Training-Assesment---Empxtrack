...
WebUI.click(findTestObject('04.3 - Leave/TC_027-success_Apply_Half_Day_Casual/Page_Home page/input_Starts from second-half of 3101_dataObject.firstHalf'))

WebUI.setText(findTestObject('04 - Dashboard/04.3 - Leave/TC_026_success_Apply_Casual Leave/Page_Home page/input_Reason_Leave'), GlobalVariable.leaveReason)

WebUI.click(findTestObject('04 - Dashboard/04.3 - Leave (1)/TC_026_success_Apply_Casual Leave/Page_Home page/a_Apply02'))

WebUI.verifyElementPresent(findTestObject('06-TC_026_success_Apply_Casual Leave/Page_Home page/verify_You can not create leave request since you have reached the allowable limit of leave requests for this month'), 
    0)

WebUI.click(findTestObject('04 - Dashboard/04.3 - Leave (1)/TC_026_success_Apply_Casual Leave/Page_Home page/button_OK'))
