...
WebUI.verifyElementPresent(findTestObject('04 - Dashboard/04.1 - Event/TC_016-unsuccessfully_Save_Blank_Task/Page_Home page/verify_Please specify the subject'), 
    0)
