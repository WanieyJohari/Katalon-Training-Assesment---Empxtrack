...
WebUI.click(findTestObject('TC_37-see_All_Attendance/Page_Home page/a_Holiday Calendar'))

WebUI.waitForElementVisible(findTestObject('TC_37-see_All_Attendance/Page_Home page/div_Holiday CalendarHelp'), 0)

WebUI.verifyElementPresent(findTestObject('TC_37-see_All_Attendance/Page_Home page/div_Holiday CalendarHelp'), 0)
