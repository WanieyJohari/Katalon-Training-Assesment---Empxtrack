...
WebUI.click(findTestObject('05 -Self-services/TC_40-self-service_view_profile/Page_Home page/Page_Home page/Page_Home page/a_View in full page'))

WebUI.waitForElementVisible(findTestObject('05 -Self-services/TC_40-self-service_view_profile/Page_Home page/Page_Home page/Page_Home page/span_Profile sections'), 
    0)

WebUI.verifyElementPresent(findTestObject('05 -Self-services/TC_40-self-service_view_profile/Page_Home page/Page_Home page/Page_Home page/span_Profile sections'), 
    0)
