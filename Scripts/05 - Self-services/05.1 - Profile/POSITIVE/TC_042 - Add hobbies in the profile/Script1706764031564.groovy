...
WebUI.setText(findTestObject('05 -Self-services/TC_42-add_Hobbies/Page_Home page/input_Hobbies'), hobbies)

WebUI.click(findTestObject('05 -Self-services/TC_42-add_Hobbies/Page_Home page/btn_Save_Hobbies'))

WebUI.verifyElementPresent(findTestObject('05 -Self-services/TC_42-add_Hobbies/Page_Home page/div_Record has been added successfully'), 
    0)

WebUI.click(findTestObject('05 -Self-services/TC_42-add_Hobbies/Page_Home page/button_Ok'))
